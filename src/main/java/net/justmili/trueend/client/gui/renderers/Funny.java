...
public class Funny extends AbstractContainerScreen<net.justmili.trueend.client.gui.inventory.Funny> {

    public Funny(net.justmili.trueend.client.gui.inventory.Funny container, Inventory inventory, Component text) {
