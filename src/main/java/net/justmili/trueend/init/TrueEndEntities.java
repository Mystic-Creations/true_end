...
public class TrueEndEntities {
    ...
    public static final RegistryObject<EntityType<UnknownEntity>> UNKNOWN = ENTITY_TYPES
            .register("unknown", () -> EntityType.Builder.of(UnknownEntity::new, MobCategory.CREATURE)
            .sized(0.6f, 1.95f)
