...
public class TrueEndModItems {
	...
	public static final RegistryObject<Item> TRAPDOOR = block(TrueEndModBlocks.TRAPDOOR);
	public static final RegistryObject<Item> PRESSURE_PLATE = block(TrueEndModBlocks.PRESSURE_PLATE);
	public static final RegistryObject<Item> BUTTON = block(TrueEndModBlocks.BUTTON);
