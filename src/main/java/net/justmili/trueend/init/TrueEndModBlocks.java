...
import net.justmili.trueend.block.WoodenTrapdoorBlock;
import net.justmili.trueend.block.WoodenPressurePlateBlock;
import net.justmili.trueend.block.WoodenButtonBlock;
...
public class TrueEndModBlocks {
	...
	public static final RegistryObject<Block> TRAPDOOR = REGISTRY.register("trapdoor", () -> new WoodenTrapdoorBlock());
	public static final RegistryObject<Block> PRESSURE_PLATE = REGISTRY.register("pressure_plate", () -> new WoodenPressurePlateBlock());
	public static final RegistryObject<Block> BUTTON = REGISTRY.register("button", () -> new WoodenButtonBlock());
