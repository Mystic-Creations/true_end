...
public class TrueEndModGameRules {
	...
	public static final GameRules.Key<GameRules.IntegerValue> BTD_CONVERSATION_MESSEGE_DELAY = GameRules.register("btdConversationMessegeDelay", GameRules.Category.PLAYER, GameRules.IntegerValue.create(40));
